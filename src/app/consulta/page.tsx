      ...
      <header className="bg-white border-b shadow-sm sticky top-0 z-10" style={{ borderColor: 'var(--color-borde)' }}>
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-sm" style={{ color: '#004466' }}>Empadronados San Jose Pinula</h1>
              <p className="text-xs" style={{ color: 'var(--texto-secundario)' }}>Consulta interna</p>
            </div>
          </div>
          <button onClick={handleLogout} className="text-sm flex items-center gap-1.5 px-3 py-1.5 rounded-lg" style={{ color: 'var(--texto-secundario)' }} title={userEmail}>
